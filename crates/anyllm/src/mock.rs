...
use crate::{
    ...
    ChatStreamExt, ContentBlock, EmbeddingCapability, EmbeddingProvider, EmbeddingRequest,
    EmbeddingResponse, Error, ExtraMap, FinishReason, ProviderIdentity, ResponseMetadata, Result,
