...
pub use embedding::{EmbeddingCapability, EmbeddingRequest, EmbeddingResponse};
...
pub mod prelude {
    ...
    pub use crate::{
        ...
        DynChatProvider, EmbeddingCapability, EmbeddingRequest, EmbeddingResponse, Error, ErrorLog,
        ExtraMap, FallbackChatProvider, FinishReason, ImageSource, Message, OwnedToolCall,
        ProviderIdentity, ReasoningConfig, ReasoningEffort, ResponseFormat, Result, RetryPolicy,
